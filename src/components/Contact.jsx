    ...
    <div id="contact" className="contact">
      ...
      <div className="formContent">
        ...
        <div className="contactContentInfo">
          <h1 style={{ marginBottom: "20px"}}>Sunsab <span style={{ color: "#FED136" }}>Team</span></h1>
          ...
          <div className="contactContentInfoFlex">
            <LinkedInIcon style={{ marginRight: "10px", fontSize: '2.5rem' }} />
            <a href="https://www.linkedin.com/company/sunsab" target="_blank" rel="noopener noreferrer" className="contact-link">Follow us on LinkedIn</a>
          </div>
          {/* <div className="contactContentInfoFlex">
